            ...
            <div className='options'>
                {
                    options.map((item, index) => {
                        return (
                            <div className='dmas_container' onClick={() => { handleOptionClick(item) }}>
                                <img src={button} className='dmas_box' />
                                <div className='dmas_centered' style={{ "pointer-events": "none" }}> {item} </div>
                            </div>
                        )
                    })
                }
