...
function Main(props) {
    ...
    const Validate = () => {
        if((computedAnswer.numerator == (upperJaw.length))&&(computedAnswer.denominator==lowerJaw.length)){
    ...
    console.log(problem.generatedfraction1)
    console.log(problem.generatedfraction2)
