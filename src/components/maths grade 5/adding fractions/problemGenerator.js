...
const generate = () => {
    ...
    if(dif == 'b'){
        ...
        // problem = {...problem , question : `Add the fraction ${problem.generatedfraction1.numerator}/${problem.generatedfraction1.denominator} with ${problem.generatedfraction2.numerator}/${problem.generatedfraction2.denominator}`}
        problem = {...problem , answer : (new Fraction(problem.generatedfraction1.numerator,problem.generatedfraction1.denominator)).add(new Fraction(problem.generatedfraction2.numerator,problem.generatedfraction2.denominator))}        
