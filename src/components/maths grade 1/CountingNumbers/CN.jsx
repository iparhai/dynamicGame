...
export default function CountingNumbers_10_s(props) {
    ...
    const [object_10, setObject_10] = useState(getAsset.getObjectByProperty('drag|10'))
    const [object_1, setObject_1] = useState(getAsset.getObjectByProperty('drag|1'))
    const [object_5, setObject_5] = useState(getAsset.getObjectByProperty('drag|5'))
    ...
    useEffect(() => {
        ...
        // setObject_10(getAsset.getObjectByProperty("10_drag"))
